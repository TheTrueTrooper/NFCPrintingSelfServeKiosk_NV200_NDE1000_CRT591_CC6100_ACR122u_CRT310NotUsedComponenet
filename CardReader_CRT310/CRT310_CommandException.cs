...
namespace CardReader_CRT310
{
    public class CRT310_CommandException : Exception
    {
        ...
        public CRT310_CommandException(CRT310_NegativeResponseMessage ReponseOnException) : this(ReponseOnException, $"A negative Response has come back on {ReponseOnException.Command}.")
        {
        }
    }
}
